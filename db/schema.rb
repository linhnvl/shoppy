...
ActiveRecord::Schema.define(version: 2019_06_24_055141) do
  ...
  create_table "category_products", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
